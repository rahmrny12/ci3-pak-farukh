                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="<?= base_url('admin/roleaccess/') . $r['id'] ?>" class="dropdown-item has-icon"><span class="fas fa-fw fa-user mr-2"></span>Access</span></a>

                                                <a href="#" class="dropdown-item has-icon" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#roleedit<?= $r['id']; ?>"><span class="fas fa-fw fa-edit mr-2"></span>Edit</span></a>

                                                <button onclick="hapusMenu('<?= base_url('admin/hapusrole/') . $r['id'] ?>')" class="dropdown-item has-icon tombol-hapus"><span class="fas fa-fw fa-trash-alt mr-2"></span>Delete</span></button>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
